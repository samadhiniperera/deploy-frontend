...
function EventManager() {
  ...
  const checkAuth = async () => {
    try {
      ...
      // Verify organizer status - UPDATED URL
  ...
  const loadCategories = async () => {
    try {
      ...
      // UPDATED URL
      const response = await fetch(`${import.meta.env.VITE_BACKEND_URL}/api/organizer/categories`, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // UPDATED URL
      const url = editingEvent 
        ? `${import.meta.env.VITE_BACKEND_URL}/api/organizer/events/${editingEvent.event_id}`
        : `${import.meta.env.VITE_BACKEND_URL}/api/organizer/events`;
  ...
  const handleDelete = async (eventId) => {
    ...
    try {
      ...
      // UPDATED URL
      const response = await fetch(`${import.meta.env.VITE_BACKEND_URL}/api/organizer/events/${eventId}`, {
        method: 'DELETE',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
