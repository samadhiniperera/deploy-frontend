...
function ExpensesManager() {
  ...
  const checkAuth = async () => {
    try {
      ...
      // Verify organizer status
      const response = await fetch(`${import.meta.env.VITE_BACKEND_URL}/api/auth/verify-organizer`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const loadExpenses = async () => {
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_BACKEND_URL}/api/organizer/expenses`, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const url = editingExpense 
        ? `${import.meta.env.VITE_BACKEND_URL}/api/organizer/expenses/${editingExpense.expense_id}`
        : `${import.meta.env.VITE_BACKEND_URL}/api/organizer/expenses`;
  ...
  const handleDelete = async (expenseId) => {
    ...
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_BACKEND_URL}/api/organizer/expenses/${expenseId}`, {
        method: 'DELETE',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
  ...
  const setupExpensesTable = async () => {
    ...
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_BACKEND_URL}/api/organizer/setup-expenses`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
