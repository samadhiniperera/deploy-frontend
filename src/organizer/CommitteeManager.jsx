...
function CommitteeManager() {
  ...
  const loadMembers = async () => {
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_BACKEND_URL}/api/organizer/committee`, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Use member_id for update operations
      const url = editingMember 
        ? `${import.meta.env.VITE_BACKEND_URL}/api/organizer/committee/${editingMember.member_id}`
        : `${import.meta.env.VITE_BACKEND_URL}/api/organizer/committee`;
  ...
  const handleDelete = async (member_id) => {
    ...
    try {
      ...
      // Updated URL to use member_id
      const response = await fetch(`${import.meta.env.VITE_BACKEND_URL}/api/organizer/committee/${member_id}`, {
        method: 'DELETE',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
